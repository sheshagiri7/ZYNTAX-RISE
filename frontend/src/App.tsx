          ...
          {!isComplete && (
            <div style={{ textAlign: 'center', marginTop: '1.25rem' }}>
              <button 
                ...
                style={{ background: 'transparent', border: 'none', color: '#a78bfa', cursor: 'pointer', fontSize: '0.85rem', textDecoration: 'underline' }}
              >
                {showChat ? 'Hide Chatbot' : 'Ask questions to Chatbot directly →'}
              </button>
            </div>
          )}
